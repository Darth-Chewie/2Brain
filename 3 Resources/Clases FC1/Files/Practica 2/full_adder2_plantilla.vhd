...
------------------------------------------------------------------------
-- full_adder2: sumador de dos bits implementado mediante puertas lógicas
-------------------------------------------------------------------------


ENTITY full_adder2 IS
  PORT(ai1, ai2, bi1, bi2: IN bit; ci: IN bit; si1, si2: OUT bit; co: OUT bit);
END full_adder2;

--USE work.ALL;
ARCHITECTURE estructura OF full_adder2 IS

	--declaración de componentes
COMPONENT full_adder
PORT (ai, bi, ci: IN bit; si, co: OUT bit);
END COMPONENT;
...
--empieza el cuerpo de la arquitectura  
BEGIN
suma_1: full_adder PORT MAP (ai1, bi1, ci, si1, c1);
suma_2: full_adder PORT MAP (ai2, bi2, c1, si2, co);
