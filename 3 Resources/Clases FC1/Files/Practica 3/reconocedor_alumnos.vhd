...
inv_1: inv PORT MAP(q0, Nq0);
inv_2: inv PORT MAP(x, Nx);
or_2: or2 PORT MAP(s0, s1, d0);
and_3: and3 PORT MAP(Nq0, q1, Nx, s0);
and_2: and2 PORT MAP(q0, x, s1);
ffd_1: ffd PORT MAP(clk, Nx, clear, q0);
ffd_2: ffd PORT MAP(clk, d0, clear, q1);
and_22: and2 PORT MAP(q0, q1, z);
